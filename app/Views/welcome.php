...
<body>
    <nav class="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700 border">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Pesantren Al-Hidayah</span>
            </a>
    ...
    <main>
        <header>
            <h1 class="text-3xl font-bold underline">Selamat Datang</h1>
        </header>
    </main>
