        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="card bg-white p-5 mt-4 border rounded-md w-full relative overflow-x-auto">
                <div class="mb-5 p-3 bg-green-800">
                    <h4 class="font-bold uppercase text-white">Pendidikan Formal</h4>
                    <hr>
                </div>
                <div>
                    <ul class="w-full space-y-1 text-gray-500 list-inside dark:text-gray-400">
                        <li class="flex items-center border p-2">
                            <svg class="w-3.5 h-3.5 me-2 text-green-500 dark:text-green-400 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"/>
                            </svg>
                            MTS. Nurul Imamul Hasan
                        </li>
                        <li class="flex items-center border p-2">
                            <svg class="w-3.5 h-3.5 me-2 text-green-500 dark:text-green-400 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"/>
                            </svg>
                            SMK. Nurul Imamul Hasan
                        </li>
                      
                    </ul>
                </div>
                <div class="mb-5 p-3 bg-green-800 mt-4">
                    <h4 class="font-bold uppercase text-white">Ekstrakulikululer</h4>
                    <hr>
                </div>
                <div>
                    <ul class="w-full space-y-1 text-gray-500 list-inside dark:text-gray-400">
            ...
            <div class="card bg-white p-5 mt-4 border rounded-md w-full relative overflow-x-auto">
                <div class="mb-5 p-3 bg-green-800">
                    <h4 class="font-bold uppercase text-white">Pendidikan Non Formal</h4>
                    <hr>
                </div>
                <div>
                    <ul class="w-full space-y-1 text-gray-500 list-inside dark:text-gray-400">
            ...
            <div class="col-span-2 flex justify-end">
                <a href="<?=base_url('psb/create')?>" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
