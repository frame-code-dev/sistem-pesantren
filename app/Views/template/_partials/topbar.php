		...
		<div class="flex items-center justify-between">
			<div class="flex items-center justify-start rtl:justify-end">
				...
				<a href="https://flowbite.com" class="flex ms-2 md:me-24">
					<img src="<?= base_url('logo.jpg') ?>" class="h-8 me-3" alt="FlowBite Logo" />
					<span class="self-center text-xl font-bold sm:text-2xl whitespace-nowrap dark:text-white">CMS Pesantren</span>
				</a>
			</div>
