	...
	<div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
		...
		<ul class="space-y-3 font-medium mt-5 sidebar">
			...
			<?php if ($role == 'super_admin' || $role == 'admin_santri') : ?>
				...
				<hr>
			<?php endif; ?>
			<?php if ($role == 'super_admin' || $role == 'admin_keuangan' || $role == 'admin_santri') : ?>
				<li>
					...
					<ul id="keuangan" class=" py-2 space-y-2 bg-gray-100 rounded mt-3 hidden">
						...
						<?php if ($role == 'super_admin' || $role == 'admin_keuangan') : ?>
							...
							<li class="sidebar-menu">
								<a href="<?= base_url('dashboard/pemasukan-lainnya') ?>" class="text-sm flex items-center w-full p-2 text-gray-900 transition duration-75 pl-4 group hover:bg-gray-200 dark:text-gray-900 dark:hover:bg-gray-700">
									<svg class="w-4 h-4 text-gray-900 dark:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
										<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m10 16 4-4-4-4" />
									</svg>
									Pemasukan lainnya
