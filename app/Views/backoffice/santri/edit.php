            ...
            <form action="<?= base_url('dashboard/santri/update/' . $data['id']) ?>" method="POST" class="w-full mx-auto space-y-4" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-4 gap-3">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" value="<?= set_value("nisn", $data['nisn']) ?>" placeholder="Masukkan nisn" name="nisn" id="nisn" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                        <div class="text-red-500 text-xs italic font-semibold">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" value="<?= set_value("tempat_lahir", $data['tempat_lahir']) ?>" placeholder="Masukkan Tempat Lahir" name="tempat_lahir" id="tempat_lahir" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                        <div class="text-red-500 text-xs italic font-semibold">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" value="<?= set_value("no_kk", $data['no_kk']) ?>" placeholder="Masukkan No KK" name="no_kk" id="no_kk" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                        <div class="text-red-500 text-xs italic font-semibold">
                ...
                <div class="grid grid-cols-4 gap-3">
                    <div class="col-span-2">
                        ...
                        <input type="text" value="<?= set_value("nama_ibu", $data['nama_ibu']) ?>" placeholder="Masukkan Nama Ibu" name="nama_ibu" id="nama_ibu" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" maxlength="10">
                        <div class="text-red-500 text-xs italic font-semibold">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" value="<?= set_value("nama_ayah", $data['nama_ayah']) ?>" placeholder="Masukkan Nama Ayah" name="nama_ayah" id="nama_ayah" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" maxlength="10">
                        <div class="text-red-500 text-xs italic font-semibold">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" value="<?= set_value("nik_ayah", $data['nik_ayah']) ?>" placeholder="Masukkan Nik Ayah" name="nik_ayah" id="nik_ayah" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" maxlength="10">
                        <div class="text-red-500 text-xs italic font-semibold">
                ...
                <div class="grid grid-cols-4 gap-3">
                    <div class="col-span-2">
                        <?php if ($data['image']) : ?>
                            <img src="<?= base_url('upload/santri/' . $data['id'] . '/' . $data['image']) ?>" id="image" class="rounded" style="width: 400px; height: 300px;" alt="">
                        <?php else : ?>
                            <img src="<?= base_url('default.jpg') ?>" id="image" class="rounded" style="width: 400px; height: 300px;" alt="">
                        <?php endif ?>
                        ...
                        <input accept="image/png, image/jpeg, image/jpg, image/webp" name="image" class="block w-full text-sm text-gray-900 border only-image limit-size-2 border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 image" type="file" data-target="#image">
                    ...
                    <div class="col-span-2">
                        <?php if ($data['file_kk']) : ?>
                            <img src="<?= base_url('upload/santri/'. $data['id'] . '/' . $data['file_kk']) ?>" id="foto_kk" class="rounded" style="width: 400px; height: 300px;" alt="">
                        <?php else : ?>
                            <img src="<?= base_url('default.jpg') ?>" id="foto_kk" class="rounded" style="width: 400px; height: 300px;" alt="">
                        <?php endif ?>
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file_input">Foto KK</label>

                        <input accept="image/png, image/jpeg, image/jpg, image/webp" name="foto_kk" class="block w-full text-sm text-gray-900 border only-image limit-size-2 border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 image" type="file" data-target="#foto_kk">
                    ...
                    <div class="col-span-2">
                        <?php if ($data['file_akte']) : ?>
                            <img src="<?= base_url('upload/santri/' . $data['id'] . '/' . $data['file_akte']) ?>" id="foto_akte" class="rounded" style="width: 400px; height: 300px;" alt="">
                        <?php else : ?>
                            <img src="<?= base_url('default.jpg') ?>" id="foto_akte" class="rounded" style="width: 400px; height: 300px;" alt="">
                        <?php endif ?>
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file_input">Foto Akte</label>

                        <input accept="image/png, image/jpeg, image/jpg, image/webp" name="foto_akte" class="block w-full text-sm text-gray-900 border only-image limit-size-2 border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 image" type="file" data-target="#foto_akte">
                    ...
                    <div class="col-span-2">
                        <?php if ($data['file_ijazah']) : ?>
                            <img src="<?= base_url('upload/santri/' . $data['id'] . '/' . $data['file_ijazah']) ?>" id="foto_ijazah" class="rounded" style="width: 400px; height: 300px;" alt="">
                        <?php else : ?>
                            <img src="<?= base_url('default.jpg') ?>" id="foto_ijazah" class="rounded" style="width: 400px; height: 300px;" alt="">
                        <?php endif ?>
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file_input">Foto Ijazah</label>

                        <input accept="image/png, image/jpeg, image/jpg, image/webp" name="foto_ijazah" class="block w-full text-sm text-gray-900 border only-image limit-size-2 border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 image" type="file" data-target="#foto_ijazah">
                    ...
                    <div class="col-span-2">
                        <?php if ($data['file_skhu']) : ?>
                            <img src="<?= base_url('upload/santri/' . $data['id'] . '/' . $data['file_skhu']) ?>" id="foto_skhu" class="rounded" style="width: 400px; height: 300px;" alt="">
                        <?php else : ?>
                            <img src="<?= base_url('default.jpg') ?>" id="foto_skhu" class="rounded" alt="">
                        <?php endif ?>
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file_input">Foto SKHU</label>

                        <input accept="image/png, image/jpeg, image/jpg, image/webp" name="foto_skhu" class="block w-full text-sm text-gray-900 border only-image limit-size-2 border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 image" type="file" data-target="#foto_skhu">
