					...
					<ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
						...
						<li>
							<div class="flex items-center">
								...
								<a href="<?= base_url('dashboard/pengeluaran') ?>" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Pengeluaran pesantren</a>
							</div>
						</li>
						<li aria-current="page">
							<div class="flex items-center">
								...
								<span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Ubah data pengeluaran pesantren</span>
							</div>
						</li>
					</ol>
				</nav>
			...
			<form action="<?= base_url('dashboard/pengeluaran/update/' . $data->id) ?>" method="POST" class="w-full mx-auto space-y-4" enctype="multipart/form-data">
				<div class="grid grid-cols-4 gap-3">
					...
					<div class="col-span-2">
						...
						<input type="text" placeholder="Masukkan nominal pembayaran" value="<?= Helpers::formatRupiah((floatval($data->nominal))) ?>" name="nominal" id="nominal" class="rupiah bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
						<div class="text-red-500 text-xs italic font-semibold">
							<div class="text-red-500 text-xs italic font-semibold">
