...
<div class="p-4 mt-14">
	<section class="p-5 overflow-y-auto">
					...
					<ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
						...
						<li aria-current="page">
							<div class="flex items-center">
								...
								<span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Ubah data pendaftaran</span>
							</div>
						</li>
					</ol>
				</nav>
		...
		<div class="card bg-white p-5 mt-4 border rounded-md w-full relative">
			<form action="<?= base_url('dashboard/pendaftaran-ulang/update/' . $data->id) ?>" method="POST" class="w-full mx-auto space-y-4" enctype="multipart/form-data">
