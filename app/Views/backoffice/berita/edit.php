				...
				<div class="grid grid-cols-4 gap-3">
					...
					<div class="col-span-2">
						...
						<div class="flex gap-2">
							...
							<input name="gambar" accept="image/png, image/jpeg, image/jpg, image/webp" class="block w-full text-sm text-gray-900 border border-gray-300 only-image limit-size-2 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="file_input" type="file">
						</div>
					...
					<div style=" grid-column: span 4/span 4">
						...
						<textarea name="keterangan" id="editor"><?= set_value("keterangan", $data["keterangan"]) ?></textarea>
