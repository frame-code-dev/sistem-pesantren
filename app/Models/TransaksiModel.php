...
class TransaksiModel extends Model
{
	...
	public function getTotalTabungan()
	{
		return	$this->db->query('SELECT 
			...
			COALESCE((SELECT SUM(t2.nominal) FROM transaksi t2 WHERE t2.kategori = "pengeluaran" AND t2.jenis_id is null), 0) AS totalTabungan FROM transaksi t1 WHERE t1.jenis_id is null AND t1.kategori = "pemasukan";')
			->getRow();
	}
